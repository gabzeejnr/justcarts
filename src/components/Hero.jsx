        ...
        <section className="hero flex lg:h-screen p-5 md:p-10 md:pt-10">
            <div className="w-3/4 sm:w-3/5 md:w-1/2 flex flex-col self-center gap-4">
                <div className="flex flex-col gap-5">
                    ...
                    <div className="big-text text-3xl md:text-5xl font-semibold lg:max-w-2/3">Free Shipping on orders over <span className="text-green-500 font-semibold md:font-bold">$100</span></div>
